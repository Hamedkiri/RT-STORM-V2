...
def get_opts():
    ...
    p.add_argument("--det_head", type=str,
                        ...
                        default="fasterrcnn",
                        help="Type de tête de détection.")

    # Hyperparams FastRNN head
    p.add_argument("--fastrnn_hidden", type=int, default=256)
    p.add_argument("--fastrnn_bidir", action="store_true", default=True)
    p.add_argument("--fastrnn_dropout", type=float, default=0.0)
